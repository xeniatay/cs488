...
double smoothed_noise_1(double x, double y) {
  double corners = ( noise_1(x - 1, y - 1) + noise_1(x + 1, y - 1) + noise_1(x - 1, y + 1) + noise_1(x + 1, y + 1) ) / 16;
...
double smoothed_noise_2(double x, double y) {
  double corners = ( noise_2(x - 1, y - 1) + noise_2(x + 1, y - 1) + noise_2(x - 1, y + 1) + noise_2(x + 1, y + 1) ) / 16;
...
double smoothed_noise_3(double x, double y) {
  double corners = ( noise_3(x - 1, y - 1) + noise_3(x + 1, y - 1) + noise_3(x - 1, y + 1) + noise_3(x + 1, y + 1) ) / 16;
...
double smoothed_noise_4(double x, double y) {
  double corners = ( noise_4(x - 1, y - 1) + noise_4(x + 1, y - 1) + noise_4(x - 1, y + 1) + noise_4(x + 1, y + 1) ) / 16;
...
double smoothed_noise_5(double x, double y) {
  double corners = ( noise_5(x - 1, y - 1) + noise_5(x + 1, y - 1) + noise_5(x - 1, y + 1) + noise_5(x + 1, y + 1) ) / 16;
...
double perlin2d(double x, double y) {
  int num_octaves = 5, j = 0;
  double n = 10, amp = 0, total = 0, freq = 0;
  double freq1 = 2, p1 = 0.25; // persistence
  double freq2 = 2, p2 = 0.5; // persistence
  double freq3 = 2, p3 = sqrt(2.0); // persistence
  double freq4 = 2, p4 = 1; // persistence
